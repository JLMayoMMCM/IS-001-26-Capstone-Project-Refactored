  ...
  return (
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-[1.05fr_1fr]">
      ...
      >
        ...
        />
        {/* Bottom-up vignette only — the building image stays visible up top,
            and the hero text at the bottom gets just enough contrast to read. */}
        <div
        ...
        <div className="relative h-full flex flex-col p-12">
          {/* Top-left: horizontal MMCM logo in a white panel (the asset itself
              has a white background, so we keep a matching card around it). */}
          ...
          <div className="mt-8 text-[10px] uppercase tracking-widest text-white/70">
            v6.0 · {isDemoMode ? "Demo Build" : "Production"}
          </div>
        </div>
      </aside>
          ...
          <div className="rounded-2xl bg-white shadow-lg border border-slate-200 overflow-hidden">
            ...
            <div className="px-6 py-3 border-t border-slate-100 bg-slate-50/60 text-[10px] text-slate-500 flex items-center justify-between">
              ...
              <span className="font-mono">
                {isDemoMode ? "NEXT_PUBLIC_DEMO_MODE=true" : "NEXT_PUBLIC_DEMO_MODE=false"}
              </span>
            </div>
          </div>
