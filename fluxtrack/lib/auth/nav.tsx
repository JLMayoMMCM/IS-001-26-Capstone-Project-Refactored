...
export const ROLE_NAV: Record<Role, NavItem[]> = {
  faculty: [
    ...
    { href: "/faculty/attendance",         label: "Attendance",  icon: ico.clock },
    { href: "/faculty/disputes",           label: "Disputes",    icon: ico.flag },
    { href: "/faculty/settings/profile",   label: "Profile",     icon: ico.user },
  ],
  ifo_admin: [
    { href: "/ifo/ifo-dashboard",          label: "Room Map",    icon: ico.rooms },
    ...
    { href: "/ifo/ifo-academic-calendar",  label: "Calendar",    icon: ico.building },
  ],
  checker: [
